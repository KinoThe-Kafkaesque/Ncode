...
/**
 * Default keybindings that match current Code behavior.
...
export const DEFAULT_BINDINGS: KeybindingBlock[] = [
  ...
  },
  {
    ...
    bindings: {
      ...
      enter: 'chat:submit',
      // Newline entry needs both an enhanced-keyboard path and a portable
      // fallback. Raw Ctrl+J is LF, which many terminals cannot distinguish
      // from Enter; Ctrl+X Enter stays distinguishable through the chord
      // interceptor on plain terminals.
      'ctrl+j': 'chat:newline',
      'ctrl+x enter': 'chat:newline',
      up: 'history:previous',
      down: 'history:next',
