...
export type UserToolResultMessageVariant =
  | 'canceled'
  | 'rejected'
  | 'error'
  | 'success'
...
export function getUserToolResultMessageVariant(
  param: ToolResultBlockParam,
  options: {
    readonly hasResolvedToolUse: boolean
  },
): UserToolResultMessageVariant {
...
export function UserToolResultMessage(t0) {
  ...
  const variant = getUserToolResultMessageVariant(param, {
    hasResolvedToolUse: Boolean(toolUse)
  });
  if (variant === 'canceled') {
    let t1;
