...
import { useClipboardImageHintOnFocus } from '../hooks/useClipboardImageHint.js';
import { useSettings } from '../hooks/useSettings.js';
import { useTextInput } from '../hooks/useTextInput.js';
import { Box, color, useAnimationFrame, useTheme } from '../ink.js';
import { useTerminalFocusRef } from '../ink/hooks/use-terminal-focus-ref.js';
...
export default function TextInput(props: Props): React.ReactNode {
  recordRenderTrace('TextInput');
  const [theme] = useTheme();
  const terminalFocusRef = useTerminalFocusRef();
  const isTerminalFocused = terminalFocusRef.current;
  ...
  useClipboardImageHintOnFocus(!!props.onImagePaste);
