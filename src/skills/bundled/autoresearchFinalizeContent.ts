// Content for the autoresearch-finalize bundled skill.
// Upstream SKILL.md and finalize.sh inlined as template literal strings.
...
export const FINALIZE_SH: string = `#!/usr/bin/env bash
set -euo pipefail
